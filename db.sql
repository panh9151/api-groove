...
CREATE TABLE Composer (
    id_composer VARCHAR(36) DEFAULT UUID() NOT NULL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    created_at DATETIME DEFAULT NOW(),
    last_update DATETIME DEFAULT NOW() ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE Music (
    ...
    last_update DATETIME DEFAULT NOW() ON UPDATE CURRENT_TIMESTAMP,
    is_show TINYINT(1) DEFAULT 1,
    FOREIGN KEY (composer) REFERENCES Composer(id_composer) ON DELETE SET NULL ON UPDATE CASCADE
);
...
values
    ("c0001", "Sơn Tùng MTP"),
    ("c0002", "Phan Mạnh Quỳnh"),
    ("c0003", "My Entertainment"),
    ("c0004", "Khắc Hưng"),
    ("c0005", "Nhạc sĩ Lê Quang"),
    ("c0006", "Nhạc sĩ Võ Thiện Thanh"),
    ("c0007", "Nhạc sĩ Quốc An"),
    ("c0008", "Trịnh Bảo Bàng"),
    ("c0009", "Nguyễn Thúc Thùy Tiên"),
    ("c0010", "Mew Amazing"),
    ("c0011", "Nguyễn Hải Phong"),
    ("c0012", "Bùi Công Nam"),
    ("c0013", "Đen Vâu")
    ;
